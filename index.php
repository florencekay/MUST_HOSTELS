  ...
  <div class="login-right">
    <div class="login-form-wrap">
      ...
      <form method="POST" id="loginForm">
        ...
        <div class="form-group">
          ...
          <input type="text" name="identifier"
                 placeholder="e.g. MU/STU/2024/001 or your email"
                 required
      ...
      <div style="margin-top:24px;padding:14px;background:#f8fafc;border-radius:8px;font-size:12px;color:#64748b">
        ...
        Admin: <code>admin@example.com</code> / <code>password</code><br>
        Operator: <code>operator@example.com</code> / <code>password</code>
      </div>
    </div>
  </div>
</div>
